...
function Cards() {
    return (
        <div>
            <div className="row">
                <div className=' grid grid-cols-1 md:grid md:grid-cols-2 lg:grid lg:grid-cols-3 mb-20'>
                    <div className='w-72 h-96 md:w-80 md:h-96 rounded-3xl overflow-hidden shadow-lg bg-[#ED1B24] mx-auto mb-6 '>
                        <div className=''>
                            <div className='text-[#FFFFFF] mb-8 mt-12 ml-16 text-2xl font-bold'>
                                <div className="">
                                    Start with the
                                </div>
                                <div className='ml-12'>
                            ...
                            <div className='text-[#FFFFFF] text-xl ml-12 mr-8 mb-8'>
                ...
                <div className=' grid grid-cols-1 md:grid md:grid-cols-2 lg:grid lg:grid-cols-3 mb-20'>
                    ...
                    <div className='w-72 h-96 md:w-80 md:h-96 rounded-3xl overflow-hidden shadow-lg bg-[#0873BB] mx-auto mb-6'>
                        <div className='my-4'>
                            ...
                            <div className='text-[#FFFFFF] text-xl ml-12 mr-8 '>
            ...
            <div className="px-4 md:px-20 lg:px-52 text-2xl pb-24">
